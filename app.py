...
st.write("In this WebApp you will be able to observe your predicted calories burned in your body. Pass your parameters such as Age, Gender, BMI, etc., into this WebApp and then you will see the predicted value of kilocalories burned. Also, you will see some general information about your input compared to the dataset.") 
...
# Adjust sample size based on the length of similar_data
